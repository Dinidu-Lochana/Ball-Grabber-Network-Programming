...
class GameClient:
    ...
    def draw_time_selection(self):
        ...
        title = font.render("Select Time Limit", True, (0, 0, 0))
        self.screen.blit(title, (200, 100))
        
        font = pygame.font.Font(None, 50)
        one_minute = font.render("1 Minute", True, (0, 0, 0))
        two_minutes = font.render("2 Minutes", True, (0, 0, 0))
        three_minutes = font.render("3 Minutes", True, (0, 0, 0))
        quit_option = font.render("Quit", True, (0, 0, 0))
        
        self.screen.blit(one_minute, (300, 250))
        self.screen.blit(two_minutes, (300, 350))
        self.screen.blit(three_minutes, (300, 450))
        self.screen.blit(quit_option, (300, 550))
    ...
    def draw_winner(self):
        ...
        self.screen.blit(winner_text, (200, 250))
        pygame.display.flip()
    ...
    def run(self):
        ...
        while self.running:
            # Time selection
            if not self.handle_time_selection():
                break
            ...
            while self.running and not self.game_over:
                ...
                # Check if time is up
                remaining_time = self.time_limit - (current_time - self.start_time)
                if remaining_time <= 0:
                    self.game_over = True
                    self.draw_winner()
                    break
                ...
                # Draw timer
                timer_text = font.render(f"Time Left: {int(remaining_time)}s", 
                                       True, (255, 255, 255))
                self.screen.blit(timer_text, (600, 10))
